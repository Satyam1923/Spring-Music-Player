        ...
        <div>
            ...
            <div className="bg-[#18181D] gap-4 flex flex-col p-4">
                ...
                <div class="flex items-center justify-center ">
                    <button class="flex items-center bg-[#0f0f11]  border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800  hover:bg-black " onClick={goggleLogin}>
