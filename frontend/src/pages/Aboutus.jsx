...
function Aboutus() {
  return (
    <div  style={{
      ...
      <h1 className="text-center text-aliceblue text-4xl mb-10 " style={{padding:"29px",fontSize:"50px"}}>About Us</h1>
      <div className="grid grid-cols-2 gap-10" style={{padding:"32px"}}>
        <div className="p-6 border-2 border-solid border-aquamarine rounded-5 transition duration-300 text-info">
          <h2>Our Vision</h2>
          <p>
        ...
        <div className="p-6 border-2 border-solid border-yellow-300 rounded-5 transition duration-300 text-info">
          <h2>What We Offer</h2>
          <p>
        ...
        <div className="p-6 border-2 border-solid border-pink-400 rounded-5 transition duration-300 text-info">
          <h2>Our Team</h2>
          <p>
        ...
        <div className="p-6 border-2 border-solid border-gray-300 rounded-5 transition duration-300 text-info">
